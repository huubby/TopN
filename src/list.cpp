...
struct list_node* list_append(list_t *list, void *data)
{
    ...
    new_node = (struct list_node *)mem_cache_alloc(list->mem_cache);
    new_node->data = data;
    new_node->next = NULL;
...
struct list_node* list_append_unique(list_t *list, void *data,
...
struct list_node* list_insert_sorted(list_t *list, void *data,
        compare_func func, void *user_data)
{
    struct list_node *temp_node;
...
struct list_node* list_insert_before(list_t *list, struct list_node *sibling,
        void *data)
{
    struct list_node *new_node;
...
struct list_node* list_insert_after(list_t *list, struct list_node *sibling,
        void *data)
{
    struct list_node *new_node;
...
bool list_remove(list_t *list, const void *data, compare_func func,
        void *user_data)
{
    struct list_node *temp_node;
...
struct list_node* list_find(list_t *list, const void *data, compare_func func,
        void *user_data)
{
    struct list_node *temp_node;
...
void list_destroy_func(void* data)
{
